...
val updateSetup: (List<String>) -> Unit = { (teacherUsername, githubToken, sourceReposFolder, copyReposFolder) ->
    pcrpTransaction {
        AppSetup.upsert(AppSetupEntity(teacherUsername, githubToken, Path(sourceReposFolder), Path(copyReposFolder)))
    }
}